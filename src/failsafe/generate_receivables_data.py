...
from failsafe.paths import DATA_DIR
from failsafe.receivables_policy import RECEIVABLE_POLICIES

OUTPUT_PATH = DATA_DIR / "overdue_invoices.json"
        ...
        if reason == "cash_flow_delay":
            ...
            last_reminder_response = (
                ...
                if reminders_sent_count == 0
                    ...
                    ["no_response", "promised_to_pay", "promised_to_pay", "requested_extension"]
                )
            )
            ...
            if rng.random() < 0.5:
                ...
                history_signal = rng.choice(
                    ["disputes_invoices", "first_time_overdue", "always_pays_late_but_pays"]
                )
            ...
            if rng.random() < 0.6:
                ...
                last_reminder_response = rng.choice(
                    ["no_response", "no_response", "requested_extension"]
                )
